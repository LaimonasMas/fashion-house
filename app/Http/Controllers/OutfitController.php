...
class OutfitController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $outfit->save();
        return redirect()->route('outfit.index')->with('success_message', 'Outfit was created. Nice job!');
    }
    ...
    public function update(Request $request, Outfit $outfit)
    {
        ...
        $outfit->master_id = $request->master_id;
        $outfit->save();
        return redirect()->route('outfit.index')->with('success_message', 'Outfit was edited. Nice job!');
    }
