...
class MasterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $master->save();
        return redirect()->route('master.index')->with('success_message', 'The master was created. Nice job!');
    }
    ...
    public function destroy(Master $master)
    {
        ...
        $master->delete();
        return redirect()->route('master.index')->with('success_message', 'The master was deleted.');
    }
}
